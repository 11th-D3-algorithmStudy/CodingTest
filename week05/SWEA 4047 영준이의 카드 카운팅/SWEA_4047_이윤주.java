...
public class Solution {
	 ...
	 * Q. 영준이의 카드 카운팅 
	 * #문제요약 
	 * 스페이드, 다이아몬드, 하트, 클로버 무늬별로 1~13 숫자 카드 총 52장 
	 * 이미 가지고 있는 카드가 있고 게임을 하기 위해서 몇 장의 카드가 더 필요한지? 
	 * 겹치는 카드를 가지고 있다면 오류 출력 
	 * 입력 : 카드무늬+카드숫자(01~13) 의 3자리가 연결된 문자열 
	 * 출력 : 무늬 별로 부족한 카드 수 or 이미 겹치는 카드가 있으면 ERROR 출력
	 * 
	 * #풀이시간 : 
	 * #메모리/시간 : 19684 kb/ 111ms
	 * #메인접근법 
